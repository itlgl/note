---
title: Android多行TextView末尾省略问题解决
date: 2023-08-29 07:22:34 
categories: 
- note
tags: 
---
...
这是一个取巧的方案，没有动系统的setText()方法。如果要适配系统的setText()方法，需要重写setText()方法，还要重写其他几个设置文字相关的方法，可以参考[EllipsizingEndTextView](https://gist.github.com/stepango/1dcf6055a80f840f9185)的做法，我实际使用发现末尾没有出现省略号，代码需要改一点，懒的改这个代码。  
